...
if( !class_exists( 'pmPostController' ) ) :
 class pmPostController {
        ...
        function meta_option_script(){
                ...
                wp_enqueue_script('jquery-ui-slider','http://code.jquery.com/ui/1.10.3/jquery-ui.js' );
                ...
                wp_enqueue_script( 'jquery-ui-datepicker', PM_ASSECTS_URL.'js/ui/jquery.ui.datepicker.js',array('jquery') );
                wp_enqueue_script('jquery-ui-datepicker' );
                wp_enqueue_script( 'jquery-ui-timepicker-addon', PM_ASSECTS_URL.'js/ui/jquery-ui-timepicker-addon.js',array('jquery','jquery-ui-slider','jquery-ui-datepicker' ) );
