...
if( !class_exists( 'moPostController' ) ) :
 class moPostController {
        ...
        function meta_option_script(){
                ...
                wp_register_script( 'meta-option-post-script', $metaOption->assetsUrl.'js/meta_option_post.js',array('jquery','media-upload','thickbox') );
            ...
            function pm_media_upload(){
                ...
                echo $pluginCore->generate_thumb($_REQUEST['imgurl'],150,'');
