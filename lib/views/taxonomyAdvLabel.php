...
$html='';
$html .= $pluginCore->create_input("pm_taxonomy[labels][name]","text", array( 
...
$html .= $pluginCore->create_input("pm_taxonomy[labels][singular_name]","text", array( 
...
$html .= $pluginCore->create_input("pm_taxonomy[labels][search_items]","text", array( 
...
$html .= $pluginCore->create_input("pm_taxonomy[labels][add_new_item]","text", array( 
...
$html .= $pluginCore->create_input("pm_taxonomy[labels][popular_items]","text", array( 
...
$html .= $pluginCore->create_input("pm_taxonomy[labels][all_items]","text", array( 
...
$html .= $pluginCore->create_input("pm_taxonomy[labels][parent_item]","text", array( 
...
$html .= $pluginCore->create_input("pm_taxonomy[labels][parent_item_colon]","text", array( 
...
$html .= $pluginCore->create_input("pm_taxonomy[labels][edit_item]","text", array( 
...
$html .= $pluginCore->create_input("pm_taxonomy[labels][update_item]","text", array( 
...
$html .= $pluginCore->create_input("pm_taxonomy[labels][new_item_name]","text", array( 
...
$html .= $pluginCore->create_input("pm_taxonomy[labels][separate_items_with_commas]","text", array( 
...
$html .= $pluginCore->create_input("pm_taxonomy[labels][add_or_remove_items]","text", array( 
...
$html .= $pluginCore->create_input("pm_taxonomy[labels][choose_from_most_used]","text", array( 
 ...
 $html .= $pluginCore->create_input("pm_taxonomy[labels][menu_name]","text", array( 
