...
$html='';
$ptys=$pluginCore->pm_get_post_types();
...
$html .= $pluginCore->create_input("pm_taxonomy[type]","text", array( 
...
$html .= $pluginCore->create_input("pm_taxonomy[name]","text", array( 
...
$html .= $pluginCore->create_input("pm_taxonomy[label]","text", array( 
...
$html .= $pluginCore->create_input("pm_taxonomy[description]","text", array( 
...
$html .= $pluginCore->create_input("pm_taxonomy[post_types]","checkbox", array( 
                        "value"         => isset($taxonomy['post_types'])?$taxonomy['post_types']:null, 
                        "label"         => "Post types",
                        "label_extra"   =>"<span class='pm_required'>*</span>",
                        "id"            => "pm_taxonomy_post_types",
                        "class"         => "pm_input validate[required,minCheckbox[1]]",
                        "option_after"  =>"<br />",
                        "field_enclose" =>  "div class='pm_field_item'",
                        "enclose"       => "div class='pm_field'",
                        "combind"       =>true,
