    ...
    function loadUi($uis=array()){
        ...
        function create_input($name='', $type='text', $attr=array(), $options=array()){
            ...
            if( $type == 'select' ){
                ...
                global $metaOption;
                $preview_url = $metaOption->assetsUrl.'images/nopreview.gif';
                $img_media='';
                $img_media .="<div class='file_wrapper'>";
                
                    $img_media .="<div class='file_preview_thum'>";
                        $img_media .="<div class='file_thum_manage' style='display:block;'> <a href='javascript(0);'>view<a/><a href='javascript(0);'>delete</a></div>";
                            $img_media .="<img src='$preview_url' />";                        
                    $img_media .="</div>";
        ...
        function showMessage($message, $class='success', $inAdmin=false ){
            ...
            function generate_thumb($img_url, $width, $height, $cut = true){
                ...
                return (is_string($thumb)) ? get_bloginfo('wpurl') . '/' .  $thumb : "";
            }
